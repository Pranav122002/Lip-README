...
def crop_one_person():      
    ...
    for person_ID in people:
        if not os.path.exists('cropped/cropped/' + person_ID ):
            os.mkdir('sample/' + person_ID + '/')

        for data_type in data_types:
            if not os.path.exists('cropped/cropped/' + person_ID + '/' + data_type):
                os.mkdir('sample/' + person_ID + '/' + data_type)

            for phrase_ID in folder_enum:
                if not os.path.exists('cropped/cropped/' + person_ID + '/' + data_type + '/' + phrase_ID):
                    # F01/phrases/01
                    os.mkdir('sample/' + person_ID + '/' + data_type + '/' + phrase_ID)
                ...
                for instance_ID in instances:
                    ...
                    if not os.path.exists('cropped/cropped/' + person_ID + '/' + data_type + '/' + phrase_ID + '/' + instance_ID):
                        os.mkdir('sample/' + person_ID + '/' + data_type + '/' + phrase_ID + '/' + instance_ID)
